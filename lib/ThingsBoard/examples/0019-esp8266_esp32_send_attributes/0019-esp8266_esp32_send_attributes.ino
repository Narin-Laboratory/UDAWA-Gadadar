...
hkiGw-w0BAQsFAAOCAgEAVR9YqbyyqFDQDLHYGmkgJykIrGF1XIpu+ILlaS/V9lZL
...
void loop() {
  ...
  // Uploads new Attributes to ThingsBoard using MQTT.
  // See https://thingsboard.io/docs/reference/mqtt-api/#attributes-api
  // for more details
